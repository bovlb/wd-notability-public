...
import wd_notability.external_usage.namespace.builder as build_namespace_cache_module
...
class FakeSession:
    ...
    async def get_with_timings(self, url: str):
        self.calls.append(url)
