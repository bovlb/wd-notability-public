...
Persisted criteria use a 3-bit one-hot field:
- 000 = unknown
- 001 = none
- 010 = weak
- 100 = strong
...
External-usage N3 lanes are derived from the lookup cache at read time.
"""
...
_PERSISTED_CRITERION_ORDER: Final[tuple[str, ...]] = (
    "N1",
    "N2a",
    "N2b",
    "N3_inlinks",
...
def persisted_criteria() -> tuple[str, ...]:
    return _PERSISTED_CRITERION_ORDER
