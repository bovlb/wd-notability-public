...
from wd_notability.external_usage.wiki_subscribers.detector import WIKI_SUBSCRIBERS_DETECTOR
...
class WikiUsageSource(Source):
    def report_urls(self, qid: QID, context: dict) -> dict[str, str]:
        return {"ui_url": f"https://www.wikidata.org/w/index.php?title={qid}&action=info"}
