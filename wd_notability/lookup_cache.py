...
DEFAULT_LOOKUP_CACHE_PATH = Path(__file__).resolve().parent / "data" / "lookup_cache.db"
...
class LookupCache:
    def __init__(
        ...
        self._osm_usage_by_qid: dict[str, dict[str, int]] = {}
        self._sdc_usage_by_qid: dict[str, int] = {}
        self._wiki_subscribers_by_qid: set[str] = set()
        self._lock = Lock()
    ...
    def _load_snapshot(self, force: bool = False) -> None:
        ...
        self._osm_usage_by_qid = snapshot.osm_usage_by_qid
        self._sdc_usage_by_qid = snapshot.sdc_usage_by_qid
        self._wiki_subscribers_by_qid = snapshot.wiki_subscribers_by_qid
        self._loaded = True
    ...
    def stats(self) -> dict[str, int | str]:
        with self._lock:
            ...
            return {
                ...
                "osm_qids": len(self._osm_usage_by_qid),
            "sdc_qids": len(self._sdc_usage_by_qid),
            "wikisub_qids": len(self._wiki_subscribers_by_qid),
        }
